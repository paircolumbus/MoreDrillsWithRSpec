...
describe 'SuperFizzBuzz' do
  ...
  context 'fizz buzz test' do
    ...
    it "returns 'Fizz' when my #{fizzy_numbers} is divisible by 3" do
    ...
    it "returns 'Buzz' when my #{buzzy_numbers} is divisible by 5" do
    ...
    it "returns 'FizzBuzz' when #{fizzbuzz_numbers} is divisible by 3 & 5" do
    ...
    it "returns the input number when #{ordinary_numbers} isn't divisible by 3, 5, or both" do
